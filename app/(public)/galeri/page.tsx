...
export default async function GalleryPage({ searchParams }: { searchParams: Promise<SearchParams> }) {
  ...
  return (
    <div className="container py-10">
      ...
      {photos.length > 0 ? <GalleryGrid photos={photos} priorityFirst /> : <EmptyState title="Belum ada foto" description="Foto galeri akan tampil setelah alumni atau admin mengunggah kenangan." />}
